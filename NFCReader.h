...
class NFCReader : public QObject
{
 Q_OBJECT
    ...
    Q_PROPERTY(QString lastInteracted READ lastInteracted NOTIFY lastInteractedChanged)

    Q_PROPERTY(double readCoordinatesLatitude READ readCoordinatesLatitude NOTIFY coordinateLatitudeChanged)
    Q_PROPERTY(double readCoordinatesLongitude READ readCoordinatesLongitude NOTIFY coordinateLongitudeChanged)

    Q_PROPERTY(QString latitudeFromUser READ latitudeFromUser WRITE setLatitudeFromUser NOTIFY latitudeFromUserChanged)
    Q_PROPERTY(QString longitudeFromUser READ longitudeFromUser WRITE setLongitudeFromUser NOTIFY longitudeFromUserChanged)
...
public:
    ...
    double readCoordinatesLatitude() const;
    double readCoordinatesLongitude() const;

    void writeTimeToTag(QNearFieldTarget *target);



    //last interacted time
    QString lastInteracted() const;
    void writeCoordinatesLL(QNearFieldTarget *target);

    double latitudeFromUser() const;
    double longitudeFromUser() const;

    int readonce() const;
    bool doYouWantToReset() const;
...
public slots:
    ...
    //epoch time write to tag
    void setLastInteracted(QNearFieldTarget *target);
    void setReadCoordinates(QNearFieldTarget *target);





        void setLatitudeFromUser(const QString &latitudeFromUser);
        void setLongitudeFromUser(const QString &longitudeFromUser);
    ...
    //void setBlocksToZero(const bool doYouWantToReset, QNearFieldTarget *target);
...
signals:
    ...
    //time read
    void lastInteractedChanged();


    void readoncechanged();

    void coordinateLatitudeChanged();
    void coordinateLongitudeChanged();

    void latitudeFromUserChanged();
    void longitudeFromUserChanged();

    void targetResetedChanged();
...
private:
    ...
    double m_latitude;
    double m_longitude;
    QString m_lastInteracted;

    //for coordinate write select
    bool m_writeCoordinates;

    bool m_doYouWantToReset;
